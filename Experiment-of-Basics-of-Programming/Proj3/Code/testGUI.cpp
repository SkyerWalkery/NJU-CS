...
void Game::AIGame(int humanColor)
{
	...
	if (humanColor == 1)
	{
		...
		while (1)
		{
			...
			reversi->handleMessage(AIStep1.first, AIStep1.second, AIStep2.first, AIStep2.second, 0);
			if (isGameOver() != -1) break;
	...
	else if (humanColor == 0)
	{
		...
		while (1)
		{
			...
			reversi->handleMessage(AIStep1.first, AIStep1.second, AIStep2.first, AIStep2.second, 1);
			if (isGameOver() != -1) break;
		}
	}
	Sleep(10000);
