...
def test_hub():
    s = TestScenario("switch_timeout tests")
    ...
    s.expect(
        PacketInputTimeoutEvent(10.1),
        ("Timeout after 1.0s on a call to recv_packet")
    )

    # test case 3: timeout case
    reqpkt = new_packet(
        "20:00:00:00:00:01",
        "30:00:00:00:00:02",
        '192.168.1.100',
    ...
    s.expect(
        ...
        ("Ethernet frame destined for 30:00:00:00:00:02 should arrive"
         "on eth1 and eth2 after 11 seconds")
    )
